#FILMY Skopiuj lijniki 1, 2, 3,...,24 do Google Colab. W tym celu otwórz ten plik w odpowiednim formacie np. kliknij przycisk code lub https://github.com/matematyknauka/ESRGAN/blob/main/README.md?plain=1
#Konfiguracja
